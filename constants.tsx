...
export const OPUS_CLONE_PYTHON_SCRIPT = `
import os
import sys
import json
import time
...
class OpusCloneEngine:
    def __init__(self, groq_api_key):
        ...
        if not os.path.exists(self.font_path):
            print("Error: font.ttf not found in current directory.")
            sys.exit(1)
    ...
    def process(self, url):
        try:
            ...
            final_video.write_videofile("final_viral_short.mp4", fps=30, codec="libx264", audio_codec="aac")
